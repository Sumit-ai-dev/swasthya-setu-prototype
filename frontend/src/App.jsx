...
/**
 * Root application component that renders the premium header, animated main content for Home/Triage/AI Chat/Analytics, and the footer.
 *
 * The component manages the active tab state and drives conditional, animated rendering of the Home landing (with Hero and Quick Access cards), the Triage view, the AI Chat view, and the Analytics view.
 *
