...
/**
 * Render the chat UI for a medical AI assistant with messaging, language selection, and RAG-powered responses.
 *
 * Manages conversation state (messages, input, language, loading, session), sends user messages to the backend to fetch bot responses, displays bot and user messages (including optional source chips), shows a loading indicator while awaiting responses, and auto-scrolls to the latest message.
 *
 * @returns {JSX.Element} The chat component UI for asking medical questions and viewing AI responses.
 */
