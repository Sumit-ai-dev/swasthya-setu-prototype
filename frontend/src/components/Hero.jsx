...
/**
 * Render the main Hero section with 3D background, gradient overlays, centered headline and description, CTA button, stats row, and feature cards.
 * @param {{ onGetStarted: function }} props
 * @param {function} props.onGetStarted - Callback invoked when the "Get Started" button is clicked.
 * @returns {JSX.Element} The Hero React element ready for rendering.
 */
