...
/**
 * Renders the Platform Analytics dashboard with animated metric cards and a live triage distribution.
 *
 * Shows a rotating spinner while fetching summary data; once loaded, displays total consultations,
 * daily active users, average response time, and progress bars for GREEN/YELLOW/RED triage counts.
 * Animations and visual styling are applied to cards and progress fills; errors during fetch are logged
 * and the component stops the loading state.
 *
